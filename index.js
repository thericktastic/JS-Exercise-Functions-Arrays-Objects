...
function getLastCarInfo(arr) {
  const lastCarIndex = arr.length - 1;
  return `This is a ${arr[lastCarIndex].car_make} ${arr[lastCarIndex].car_model}`;
}
...
function sortCarInventory(arr) {
  ...
  return sortedArr.sort(function(car1,car2){
